...
// 字体大小定义规范
$fontsize-large-xxxx = 0.3rem
$fontsize-large-xxx = 0.24rem
$fontsize-large-xx = 0.2rem
$fontsize-large-x = 0.18rem
$fontsize-large = 0.16rem
$fontsize-medium = 0.14rem
$fontsize-small = 0.12rem
$fontsize-small-s = 0.10rem
...
/// 内容区阴影
$box-shadow-content = 0 0.01rem 0.03rem rgba(0, 0, 0, .1)
  ...
  .picker
    ...
    .picker-panel
      ...
      &.picker-move-enter, &.picker-move-leave-active
        transform: translate3d(0, 2.73rem, 0)
      ...
      .picker-choose
        ...
        .picker-title
          ...
          border-bottom 0.01rem solid rgba(#32384c, 0.7)
        .confirm, .cancel
          position: absolute
          top: 0rem
      ...
      .picker-content
        ...
        .mask-top
          position: absolute
          top: 0
          background: linear-gradient(to top, rgba($color-white, 0.4), rgba($color-white, 0.8))
        .mask-bottom
          position: absolute
          bottom: 1px
          background: linear-gradient(to bottom, rgba($color-white, 0.4), rgba($color-white, 0.8))
      .wheel-wrapper
        display: flex
        padding: 0 0.16rem
        .wheel
